...
<p align="center">
  <img src="images/demo.png" alt="智能问答界面" width="700">
</p>

*上图展示了用户在界面中输入问题“人工智能是什么？”，系统基于上传的文档给出了回答并附上了引用来源。*
## 🚀 快速开始
...
1. **克隆仓库**
   ```bash
   git clone https://github.com/Kiana1020/rag-qa-system.git
   cd rag-qa-system
   ```
...
> 根据文档《test.txt》，人工智能主要包括机器学习、计算机视觉、自然语言处理和机器人学等分支。  
> *（同时显示引用来源）*
